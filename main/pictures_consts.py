...
instructions_pic = pygame.image.load("main/pictures/instructions_pic.jpg")
taking_pictures_pic = pygame.image.load("main/pictures/red_dot.jpg")
processing_pic0 = pygame.image.load("main/pictures/processing_pic0.jpg")
processing_pic1 = pygame.image.load("main/pictures/processing_pic1.jpg")
processing_pic2 = pygame.image.load("main/pictures/processing_pic2.jpg")
processing_pic3 = pygame.image.load("main/pictures/processing_pic3.jpg")
model_view_pic = pygame.image.load("main/pictures/model_view_pic.jpg")
error_pic = pygame.image.load("main/pictures/error_pic.jpg")
camera_error_pic = pygame.image.load("main/pictures/camera_error_pic.png")
face_pic = pygame.image.load("main/pictures/face_pic.png")
