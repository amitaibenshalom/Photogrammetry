...
# Example usage:
input_file_path = r'C:\Users\mada\Documents\photogrammetry\photogrammetry_data\2024-01-09-14-10-30-9874\output\texturedMesh.obj'
center_object(input_file_path)
